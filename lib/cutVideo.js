...
export function cutClip({
  ...
  return new Promise((resolve, reject) => {
    ...
    if (vertical) {
      ...
      // Visual mais escuro e dramático — brilho reduzido e contraste/
      // saturação um pouco mais fortes, tipo os cortes de true crime.
      filters.push('eq=brightness=-0.15:contrast=1.2:saturation=1.15');
    }
