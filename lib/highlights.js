...
Identifique entre ${minClips} e ${maxClips} trechos com o maior potencial de viralizar como cortes curtos e independentes. Priorize:
- Gancho forte nos primeiros 3 segundos (pergunta provocativa, afirmação polêmica, revelação)
...
{"clips":[{"start":<número>,"end":<número>,"title":"<título curto>","hook":"<frase de abertura>","reason":"<motivo em 1 frase>","score":<0-100>}]}`;
